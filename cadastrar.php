...
// CADASTRA DISPOSITIVO...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $dispositivo->cadastraDispositivo(
            ...
            $_POST['email_usuario'],
            $_POST['nome_gestor'],
            $_POST['nome_ponto_focal']
        );

        header('Refresh: 1 cadastrar.php');
        echo "<div class='back'><img src='img/confirmacao.png' id='confirmacao'><h3>Dispositivo cadastrado com sucesso!</h3></div> </div>";
        echo "<style>
                        .back {
                            width: 100%;
                            height: 100%;
            ...
            <article class="conteudo">
                ...
                <section class="conteudo-center">
                    ...
                    <form class="" action="cadastrar.php" method="post">
                        ...
                        <label>
                            <p>Marca<span style="color: #ff0000"> *</span></p>
                            <input type="text" name="marca" id="marca" placeholder="Insira a marca" required>
                        </label>
                        <label>
                            <p>Modelo<span style="color: #ff0000"> *</span></p>
                        ...
                        <label>
                            <p>Estado UF<span style="color: #ff0000"> *</span></p>
                        ...
                        <label>
                            <p>Centro de Custo<span style="color: #ff0000"> *</span></p>
                            <input type="number" name="cdc" id="cdc" placeholder="Insira o CDC" required>
                        </label>
                        <label>
                            <p>Unidade<span style="color: #ff0000"> *</span></p>
                        ...
                        <label>
                            <p>Nome gestor<span style="color: #ff0000"> *</span></p>
                            <input type="text" name="nome_gestor" id="nome_gestor" placeholder="Insira o gestor" required>
                        </label>
                        <label>
                            <p>Nome Ponto Focal<span style="color: #ff0000"> *</span></p>
